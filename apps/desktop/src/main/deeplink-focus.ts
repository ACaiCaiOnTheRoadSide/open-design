 ...
 * `BrowserWindow.getAllWindows()[0]`: a packaged cold start creates the splash
 * before the main window, so window 0 may not be the main app window while boot
 * is in progress. Focusing it is a silent no-op.
