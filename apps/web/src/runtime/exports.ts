...
// (different per environment). Fired at module load so the result is cached
// long before the user clicks export. Standalone mode (no backend) 404s
// silently and falls back to the public default.
