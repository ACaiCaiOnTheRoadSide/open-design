...
export const ru: Dict = {
  ...
  'fileViewer.exportToMonkeycodeEditHint': 'Этот промпт будет передан в MonkeyCode и подставлен в поле задачи (также скопирован в буфер обмена как резерв). При необходимости отредактируйте его перед продолжением.',
