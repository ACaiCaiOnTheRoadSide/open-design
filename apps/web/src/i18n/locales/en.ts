...
export const en: Dict = {
  ...
  'fileViewer.exportToMonkeycodeEditHint': 'This prompt will be carried to MonkeyCode and pre-filled into the task box (also copied to your clipboard as a backup). Edit it before continuing if needed.',
