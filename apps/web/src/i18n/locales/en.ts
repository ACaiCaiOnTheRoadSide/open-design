...
export const en: Dict = {
  ...
  'dsManager.deleteConfirm': 'Delete "{title}"? This can\'t be undone.',
  ...
  'ds.deleteProjectConfirm': 'Delete "{title}"? This permanently removes the design system and its project and can\'t be undone.',
