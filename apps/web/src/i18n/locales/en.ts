...
export const en: Dict = {
  ...
  'homeHero.subtitlePrefix': 'Choose a template or start a new creation from scratch.',
  ...
  'fileViewer.exportPptxAgentQueued': 'Handed to the AI agent — the .pptx will appear in your file list when ready.',
  'fileViewer.exportImageAgentQueued': 'Handed to the AI agent — the image will appear in your file list when ready.',
  'fileViewer.exportPdfAgentQueued': 'Handed to the AI agent — the .pdf will appear in your file list when ready.',
  ...
  'templateRec.applyFailed': 'Failed to apply the template — please try again',
  'templateRec.loading': 'Finding templates…',
  'templateRec.title': 'Recommended for you',
  'templateRec.use': 'Use this template',
  'templateRec.next': 'Show another',
  'templateRec.dismiss': 'No thanks',
  'templateRec.degraded': 'Keyword match (no recommendation model configured)',
  'templateRec.switchPrompt': 'I\'ve switched to the "{name}" template. Please rework the current project to follow this template\'s structure and style.',
  'assistant.endCanceled': 'Stopped manually',
  'assistant.endInterrupted': 'Interrupted by a service restart',
  'assistant.endTruncated': 'Output length limit reached — the reply may be truncated',
  'assistant.endIdleWrapUp': 'No new output — wrapped up automatically',
  'assistant.endFailed': 'Ended with an error',
  'feedback.entryLabel': 'Report an issue',
  'feedback.dialogTitle': 'Report an issue',
  'feedback.dialogHint': 'Tell us what went wrong — we will follow up as soon as possible.',
  'feedback.titleLabel': 'Title',
  'feedback.titlePlaceholder': 'Brief summary of the issue',
  'feedback.contentLabel': 'Description',
  'feedback.contentPlaceholder': 'Describe the issue: steps to reproduce, expected and actual behavior…',
  'feedback.attachLabel': 'Screenshots',
  'feedback.attachAdd': 'Add screenshot',
  'feedback.attachHint': 'Up to 3 images, 5MB each. You can paste screenshots directly.',
  'feedback.attachInvalid': 'Images only — up to 3, max 5MB each.',
  'feedback.remove': 'Remove',
  'feedback.submit': 'Submit',
  'feedback.cancel': 'Cancel',
  'feedback.success': 'Feedback submitted. Thank you!',
  'feedback.error': 'Failed to submit. Please try again later.',
  ...
  'settings.accentColorDefault': 'Default accent color',
  'settings.accentColorCustom': 'Custom theme color',
  'fileViewer.publish': 'Publish',
  'fileViewer.publishTooltip': 'Publish as a live web page',
  'fileViewer.publishConfirmTitle': 'Publish to showcase',
  'fileViewer.publishNotice': 'Once a moderator approves it, it appears on the public showcase wall — anyone can view it. Next, the AI will ask you for a name and a short description.',
  'fileViewer.publishConfirm': 'Continue',
  'fileViewer.publishAgentQueued': 'Handed to the AI — answer the publish details in the chat.',
  ...
  'fileViewer.exportToMonkeycodeCopyFailed': 'Failed to copy the prompt to your clipboard',
  'fileViewer.exportToMonkeycodePopupBlocked': 'The browser blocked the new tab; the prompt is on your clipboard — open MonkeyCode manually and paste it',
  'fileViewer.exportToMonkeycodeOpenFailed': 'Could not open MonkeyCode and the prompt failed to copy — please try again',
