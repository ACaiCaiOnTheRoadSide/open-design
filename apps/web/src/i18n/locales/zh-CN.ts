...
export const zhCN: Dict = {
  ...
  'fileViewer.exportToMonkeycodeCopyFailed': '复制提示词失败，请重试',
  ...
  'fileViewer.exportToMonkeycodeReadyTitle': '提示词已复制',
  'fileViewer.exportToMonkeycodeReadyMessage': '开发提示词已复制到剪贴板，前往 MonkeyCode 粘贴即可开始开发。',
