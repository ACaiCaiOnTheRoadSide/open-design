...
export const zhCN: Dict = {
  ...
  "homeHero.subtitlePrefix": "全场景设计平台",
  ...
  "fileViewer.exportImageAgentQueued": "已交给 AI 生成，完成后图片会出现在文件列表中。",
  "fileViewer.exportPdfAgentQueued": "已交给 AI 生成，完成后 .pdf 会出现在文件列表中。",
  ...
  'templateRec.applyFailed': '模板应用失败，请重试',
  'templateRec.emptyToast': '暂时没有找到匹配的模板，换个描述再试试',
  'templateRec.hoverTip': '在输入框里描述你的需求，点击即可获得模板推荐',
  'templateRec.loading': '正在为你挑选模板…',
  'templateRec.title': '为你推荐',
  'templateRec.use': '使用此模板',
  'templateRec.next': '换一个',
  'templateRec.dismiss': '不使用',
  'templateRec.degraded': '关键词匹配结果（未配置推荐模型）',
  'templateRec.switchPrompt': '我已切换到模板「{name}」，请基于当前项目的内容，按这个模板的结构与风格重新组织产出。',
  'assistant.endCanceled': '已手动停止',
  'assistant.endInterrupted': '服务重启，运行中断',
  'assistant.endTruncated': '达到输出长度上限，回复可能被截断',
  'assistant.endIdleWrapUp': '长时间无新输出，已自动收尾',
  'assistant.endFailed': '运行异常结束',
  'feedback.entryLabel': '问题反馈',
  'feedback.dialogTitle': '问题反馈',
  'feedback.dialogHint': '描述你遇到的问题，我们会尽快跟进处理。',
  'feedback.titleLabel': '标题',
  'feedback.titlePlaceholder': '简要概括问题',
  'feedback.contentLabel': '问题描述',
  'feedback.contentPlaceholder': '详细描述问题：复现步骤、期望与实际结果…',
  'feedback.attachLabel': '截图附件',
  'feedback.attachAdd': '添加截图',
  'feedback.attachHint': '最多 3 张、每张不超过 5MB，可直接粘贴截图。',
  'feedback.attachInvalid': '仅支持图片，最多 3 张、每张不超过 5MB。',
  'feedback.remove': '移除',
  'feedback.submit': '提交',
  'feedback.cancel': '取消',
  'feedback.success': '反馈已提交，感谢你的反馈！',
  ...
  'settings.accentColorDefault': '默认主题色',
  'settings.accentColorCustom': '自定义主题色',
  'fileViewer.publish': '发布',
  'fileViewer.publishTooltip': '发布为在线网页',
  'fileViewer.publishConfirmTitle': '发布到案例墙',
  'fileViewer.publishNotice': '发布后由管理员审核,通过后会在公开案例墙上展示,任何人都能访问。接下来 AI 会问你作品名称和简介。',
  'fileViewer.publishConfirm': '继续发布',
  'fileViewer.publishAgentQueued': '已交给 AI 发布,请在对话里填写发布信息。',
  ...
  'fileViewer.exportToMonkeycodeLoading': '正在上传设计产物…',
  ...
  'fileViewer.exportToMonkeycodeCopyFailed': '提示词复制到剪贴板失败',
  'fileViewer.exportToMonkeycodePopupBlocked': '浏览器拦截了新窗口；提示词已复制到剪贴板，请手动打开 MonkeyCode 后粘贴',
  'fileViewer.exportToMonkeycodeOpenFailed': '无法打开 MonkeyCode，且提示词复制失败，请重试',
  'fileViewer.exportToMonkeycodeGo': '前往 MonkeyCode',
  'fileViewer.exportToMonkeycodeCancel': '稍后再说',
