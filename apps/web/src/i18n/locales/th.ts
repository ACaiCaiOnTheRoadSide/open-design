...
export const th: Dict = {
  ...
  'fileViewer.exportToMonkeycodeEditHint': 'พรอมป์นี้จะถูกนำไปยัง MonkeyCode และกรอกในช่องงานโดยอัตโนมัติ (คัดลอกไปยังคลิปบอร์ดสำรองด้วย) แก้ไขก่อนดำเนินการต่อได้ตามต้องการ',
