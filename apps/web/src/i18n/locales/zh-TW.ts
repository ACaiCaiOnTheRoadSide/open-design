...
export const zhTW: Dict = {
  ...
  "homeHero.subtitlePrefix": "選擇左側範本，或從空白任務開始創作。",
  ...
  "fileViewer.exportPptxAgentQueued": "已交給 AI 生成，完成後 .pptx 會出現在檔案列表中。",
  "fileViewer.exportImageAgentQueued": "已交給 AI 生成，完成後圖片會出現在檔案列表中。",
  "fileViewer.exportPdfAgentQueued": "已交給 AI 生成，完成後 .pdf 會出現在檔案列表中。",
  ...
  'templateRec.applyFailed': '模板套用失敗，請重試',
  'templateRec.emptyToast': '暫時沒有找到匹配的模板，換個描述再試試',
  'templateRec.hoverTip': '在輸入框裡描述你的需求，點擊即可獲得模板推薦',
  'templateRec.loading': '正在為你挑選模板…',
  'templateRec.title': '為你推薦',
  'templateRec.use': '使用此模板',
  'templateRec.next': '換一個',
  'templateRec.dismiss': '不使用',
  'templateRec.degraded': '關鍵字比對結果（未設定推薦模型）',
  'templateRec.switchPrompt': '我已切換到模板「{name}」，請基於目前專案的內容，依這個模板的結構與風格重新組織產出。',
  'assistant.endCanceled': '已手動停止',
  'assistant.endInterrupted': '服務重啟，執行中斷',
  'assistant.endTruncated': '達到輸出長度上限，回覆可能被截斷',
  'assistant.endIdleWrapUp': '長時間無新輸出，已自動收尾',
  'assistant.endFailed': '執行異常結束',
  'feedback.entryLabel': '問題回饋',
  'feedback.dialogTitle': '問題回饋',
  'feedback.dialogHint': '描述你遇到的問題，我們會盡快跟進處理。',
  'feedback.titleLabel': '標題',
  'feedback.titlePlaceholder': '簡要概括問題',
  'feedback.contentLabel': '問題描述',
  'feedback.contentPlaceholder': '詳細描述問題：重現步驟、預期與實際結果…',
  'feedback.attachLabel': '截圖附件',
  'feedback.attachAdd': '新增截圖',
  'feedback.attachHint': '最多 3 張、每張不超過 5MB，可直接貼上截圖。',
  'feedback.attachInvalid': '僅支援圖片，最多 3 張、每張不超過 5MB。',
  'feedback.remove': '移除',
  'feedback.submit': '送出',
  'feedback.cancel': '取消',
  'feedback.success': '回饋已送出，感謝你的回饋！',
  'feedback.error': '送出失敗，請稍後再試。',
  'entry.backToHome': '返回首頁',
  'templateRec.entryOpen': '请先使用或关闭当前推荐',
  'templateRec.continueWith': '使用“{name}”模板并继续当前项目。',
  ...
  'settings.accentColorHint': '选择用于操作按钮和重点内容的主题色。',
  'settings.accentColorDefault': '預設主題色',
  'settings.accentColorCustom': '自定义主题色',
  'fileViewer.publish': '發佈',
  'fileViewer.publishTooltip': '發佈為線上網頁',
  'fileViewer.publishConfirmTitle': '發佈到案例牆',
  'fileViewer.publishNotice': '發佈後由管理員審核,通過後會在公開案例牆上展示,任何人都能存取。接下來 AI 會詢問你作品名稱與簡介。',
  'fileViewer.publishConfirm': '繼續發佈',
  'fileViewer.publishAgentQueued': '已交給 AI 發佈,請在對話中填寫發佈資訊。',
  ...
  'fileViewer.exportToMonkeycodeCopyFailed': '提示詞複製到剪貼簿失敗',
  'fileViewer.exportToMonkeycodePopupBlocked': '瀏覽器攔截了新視窗；提示詞已複製到剪貼簿，請手動開啟 MonkeyCode 後貼上',
  'fileViewer.exportToMonkeycodeOpenFailed': '無法開啟 MonkeyCode，且提示詞複製失敗，請重試',
  'fileViewer.exportToMonkeycodeGo': '前往 MonkeyCode',
  'fileViewer.exportToMonkeycodeCancel': '稍後再說',
  'designReferences.confirm': '确认选择',
  'designReferences.previous': '上一轮',
  'designReferences.next': '下一轮',
  'designReferences.reject': '都不喜欢',
};
