...
export const ar: Dict = {
  ...
  'fileViewer.exportToMonkeycodeEditHint': 'سيُنقل هذا الموجّه إلى MonkeyCode ويُملأ تلقائيًا في حقل المهمة (ويُنسخ أيضًا إلى الحافظة كنسخة احتياطية). حرّره قبل المتابعة إذا لزم الأمر.',
