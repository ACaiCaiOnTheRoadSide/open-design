...
export const fa: Dict = {
  ...
  'fileViewer.exportImageAgentQueued': 'به عامل هوش مصنوعی سپرده شد — تصویر پس از آماده شدن در فهرست فایل‌ها نمایان می‌شود.',
  'fileViewer.exportPdfAgentQueued': 'به عامل هوش مصنوعی سپرده شد — فایل .pdf پس از آماده شدن در فهرست فایل‌ها نمایان می‌شود.',
  ...
  'templateRec.applyFailed': 'اعمال قالب ناموفق بود — دوباره تلاش کنید',
  'templateRec.loading': 'در حال یافتن قالب‌ها…',
  'templateRec.title': 'پیشنهادی برای شما',
  'templateRec.use': 'استفاده از این قالب',
  'templateRec.next': 'نمایش قالب دیگر',
  'templateRec.dismiss': 'استفاده نکن',
  'templateRec.degraded': 'تطبیق کلیدواژه (مدل پیشنهاد پیکربندی نشده)',
  'templateRec.switchPrompt': 'به قالب «{name}» تغییر دادم. لطفاً پروژه فعلی را مطابق ساختار و سبک این قالب بازسازی کنید.',
  'assistant.endCanceled': 'به‌صورت دستی متوقف شد',
  'assistant.endInterrupted': 'به دلیل راه‌اندازی مجدد سرویس قطع شد',
  'assistant.endTruncated': 'به سقف طول خروجی رسید — پاسخ ممکن است ناقص باشد',
  'assistant.endIdleWrapUp': 'خروجی جدیدی نبود — به‌طور خودکار جمع‌بندی شد',
  'assistant.endFailed': 'با خطا پایان یافت',
  'feedback.entryLabel': 'گزارش مشکل',
  'feedback.dialogTitle': 'گزارش مشکل',
  'feedback.dialogHint': 'مشکلی که با آن روبه‌رو شدید را شرح دهید — در اسرع وقت پیگیری می‌کنیم.',
  'feedback.titleLabel': 'عنوان',
  'feedback.titlePlaceholder': 'خلاصه‌ای کوتاه از مشکل',
  'feedback.contentLabel': 'شرح',
  'feedback.contentPlaceholder': 'مشکل را شرح دهید: مراحل بازتولید، رفتار مورد انتظار و واقعی…',
  'feedback.attachLabel': 'اسکرین‌شات‌ها',
  'feedback.attachAdd': 'افزودن اسکرین‌شات',
  'feedback.attachHint': 'حداکثر ۳ تصویر، هر کدام تا ۵ مگابایت. می‌توانید اسکرین‌شات را مستقیم جای‌گذاری کنید.',
  'feedback.attachInvalid': 'فقط تصویر — حداکثر ۳ عدد، هر کدام تا ۵ مگابایت.',
  'feedback.remove': 'حذف',
  'feedback.submit': 'ارسال',
  'feedback.cancel': 'لغو',
  'feedback.success': 'بازخورد ارسال شد. سپاسگزاریم!',
  'feedback.error': 'ارسال ناموفق بود. لطفاً بعداً دوباره تلاش کنید.',
  ...
  'settings.accentColorDefault': 'رنگ تأکید پیش‌فرض',
  'settings.accentColorCustom': 'Custom theme color',
  'fileViewer.publish': 'انتشار',
  'fileViewer.publishTooltip': 'انتشار به‌صورت صفحه وب',
  'fileViewer.publishConfirmTitle': 'انتشار در ویترین',
  'fileViewer.publishNotice': 'پس از تأیید مدیر، در ویترین عمومی نمایش داده می‌شود و همه می‌توانند آن را ببینند. سپس هوش مصنوعی نام و توضیح کوتاه را می‌پرسد.',
  'fileViewer.publishConfirm': 'ادامه',
  'fileViewer.publishAgentQueued': 'به هوش مصنوعی سپرده شد — اطلاعات انتشار را در گفتگو وارد کنید.',
  ...
  'fileViewer.exportToMonkeycodeCopyFailed': 'کپی پرامپت در کلیپ‌بورد ناموفق بود',
  'fileViewer.exportToMonkeycodePopupBlocked': 'مرورگر پنجره جدید را مسدود کرد؛ پرامپت در کلیپ‌بورد است — MonkeyCode را دستی باز کنید و بچسبانید',
  'fileViewer.exportToMonkeycodeOpenFailed': 'باز کردن MonkeyCode ممکن نشد و کپی پرامپت هم ناموفق بود — دوباره تلاش کنید',
