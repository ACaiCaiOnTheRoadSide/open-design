...
export const fa: Dict = {
  ...
  'fileViewer.exportToMonkeycodeEditHint': 'این پرامپت به MonkeyCode منتقل و به‌طور خودکار در کادر وظیفه درج می‌شود (به‌عنوان پشتیبان در کلیپ‌بورد نیز کپی می‌شود). در صورت نیاز پیش از ادامه آن را ویرایش کنید.',
