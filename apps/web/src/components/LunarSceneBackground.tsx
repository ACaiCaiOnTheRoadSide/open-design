...
export function LunarSceneBackground({ theme }: { theme?: AppTheme }) {
  ...
  if (fallback === 'video') {
    return (
      ...
      >
        <source
          media="(min-width: 1280px) and (min-resolution: 2dppx), (min-width: 2560px)"
          src="/backgrounds/lunar-globe-rotation-4k.mp4"
          type="video/mp4"
        />
        <source
          media="(min-width: 1024px) and (min-resolution: 1.5dppx), (min-width: 1600px)"
          src="/backgrounds/lunar-globe-rotation-3k.mp4"
          type="video/mp4"
        />
        <source
          src="/backgrounds/lunar-globe-rotation-1280.mp4"
          type="video/mp4"
        />
      </video>
    );
