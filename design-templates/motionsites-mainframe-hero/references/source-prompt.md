...
Load the bundled variable font from `./assets/fonts/albert-sans-variable.woff2`; do not add a remote font dependency.

In `index.css`, define the font face and CSS variables:
```css
@font-face {
  font-family: 'Albert Sans';
  src: url('./assets/fonts/albert-sans-variable.woff2') format('woff2');
  font-style: normal;
  font-weight: 100 900;
  font-display: swap;
}
:root {
  --font-heading: 'Albert Sans', 'Helvetica Neue', Arial, sans-serif;
